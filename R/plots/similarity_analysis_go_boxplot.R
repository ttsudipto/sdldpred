...
# cluster_similarity_cosine_bkm_mf <- read_cluster_similarity_go_gene_union(similarity = "cosine", cluster_algo = "bkm", ontology = "MF", cluster_cutoff = 80)
# cluster_similarity_df_cosine_bkm_mf <- convert_to_df(cluster_similarity_cosine_bkm_mf)
# cluster_similarity_cosine_bkm_bp <- read_cluster_similarity_go_gene_union(similarity = "cosine", cluster_algo = "bkm", ontology = "BP", cluster_cutoff = 80)
# cluster_similarity_df_cosine_bkm_bp <- convert_to_df(cluster_similarity_cosine_bkm_bp)
# cluster_similarity_cosine_bkm_cc <- read_cluster_similarity_go_gene_union(similarity = "cosine", cluster_algo = "bkm", ontology = "CC", cluster_cutoff = 80)
# cluster_similarity_df_cosine_bkm_cc <- convert_to_df(cluster_similarity_cosine_bkm_cc)
# plot_bkm_mf <- make_box_plot(cluster_similarity_df_cosine_bkm_mf, ontology="MF", title="(a)")
# plot_bkm_bp <- make_box_plot(cluster_similarity_df_cosine_bkm_bp, ontology="BP", title="(b)")
# plot_bkm_cc <- make_box_plot(cluster_similarity_df_cosine_bkm_cc, ontology="CC", title="(c)")
